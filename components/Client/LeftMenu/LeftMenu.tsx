...
import styles from "@/styles/components/Client/LeftMenu/LeftMenu.module.css";
...
import ClickAddChannel from "@/components/Client/LeftMenu/ClickAddChannel";
...
export default function LeftMenu() {
  ...
  return (
    <>
      ...
      <AddSpaceMembers
        setOpen={setAddSpaceMembers}
        Open={addSpaceMembers}
      ...
      >
            ...
            >
              ...
              >
                {ChannelsState.filter((obj: any, index) => {
                  ...
                  <div
                    key={index}
                    className={styles.WrapperChannelItemGrid}
                  ...
                  >
                    <div className={styles.ChannelItemGrid}>
        ...
        <div className={styles.vericleProgress}>
          <TotalProgess />
          <Progressbar />
        </div>
      </div>
